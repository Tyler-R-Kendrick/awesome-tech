...
These instructions apply to `agent-optimization/`.
...
- Run `rg "^## Table of Contents" agent-optimization README.md standards/README.md` before committing documentation changes.
