...
These instructions apply to `prompt-engineering/`.
...
- Run `rg "^## Table of Contents" prompt-engineering README.md standards/README.md` before committing documentation changes.
